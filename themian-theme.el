    ...
    (themian--unroll-parents
     (themian--with-color-variables variant
       `(;; each face is of the format: (FACE &optional PARENTS ATTRIBUTES)
         ...
         (font-lock-misc-punctuation-face nil (:foreground ,base+1))
         ...
         (font-lock-regexp-face nil (:foreground ,orange :background ,base-3))
         ...
         (compilation-info nil (:foreground ,blue))
         ...
         (flycheck-error nil (:background ,base-3))
         (flycheck-error-list-info nil (:foreground ,cyan))
         (flycheck-fringe-error themian-error)
         (flycheck-fringe-info nil (:foreground ,cyan))
         (flycheck-fringe-warning themian-warning)
         (flycheck-info nil (:background ,cyan-bg))
         (flycheck-warning nil (:background ,base-5))
         ...
         (lsp-face-highlight-read nil (:background ,base-5))
         (lsp-face-highlight-textual nil (:background ,base-5))
         (lsp-face-highlight-write nil (:background ,base-5 :weight bold))
         (lsp-flycheck-info-unnecessary-face nil (:underline (:color ,cyan :style wave)))
         (lsp-ui-sideline-global nil (:background ,base-5 :width semi-condensed :slant italic))
         ...
         (org-level-1 themian-heading (:height 1.4 :weight bold :background ,base-3 :extend t))
         (org-level-2 themian-heading (:height 1.3 :weight semi-bold))
         (org-level-3 themian-heading (:height 1.2))
         (org-level-4 themian-heading (:height 1.1 :slant italic))
         (org-level-5 themian-heading (:height 1.1))
         (org-level-6 themian-heading (:height 1.0 :slant italic))
         (org-level-7 themian-heading (:height 1.0))
         (org-level-8 themian-heading (:height 1.0 :slant italic))
         (org-link link)
         ...
         (show-paren-match nil (:background ,base-3 :weight bold))
         (show-paren-match-expression show-paren-match)
         (show-paren-mismatch nil (:background ,red-bg :weight bold))
         ...
         (spaceline-highlight-face nil (:background ,base+2 :foreground ,base-4))
