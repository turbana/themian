  ...
  (apply
   ...
   (themian-with-color-variables
     ...
     `(
       ...
       (org-drawer (:inherit org-block-begin-line))
       ...
       (org-level-1 (:inherit org-level-2))
       (org-level-2 (:inherit org-level-3))
       (org-level-3 (:inherit org-level-4))
       (org-level-4 (:inherit org-level-5))
       (org-level-5 (:inherit org-level-6))
       (org-level-6 (:inherit org-level-7))
       (org-level-7 (:inherit org-level-8))
       (org-level-8 (:foreground ,orange :height 1.2 :extend nil))
       ...
       (org-todo (:foreground ,yellow :weight bold :height 0.9))
