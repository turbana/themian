    ...
    (themian--unroll-parents
     (themian--with-color-variables variant
       `(;; each face is of the format: (FACE &optional PARENTS ATTRIBUTES)
         ...
         (flycheck-error nil (:background ,red-bg))
         ...
         (flycheck-warning nil (:background ,yellow-bg))
         ...
         (lsp-face-highlight-read nil (:background ,base-3))
         (lsp-face-highlight-textual nil (:background ,base-3))
         (lsp-face-highlight-write nil (:background ,base-3 :weight bold))
         (lsp-flycheck-info-unnecessary-face nil (:underline (:color ,cyan :style wave)))
         (lsp-ui-sideline-global nil (:background ,base-3))
