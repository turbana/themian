          ...
          (when (member face themian-force-fixed-faces)
            (setq parents
                  (cond ((eq parents nil)
                         'fixed-pitch)
                        ((listp parents)
                         (append '(fixed-pitch) parents))
                        (t
                         (list 'fixed-pitch parents)))))
  ...
  (apply
   ...
   (themian-with-color-variables variant
     `(
       ...
       (themian-header nil (:foreground ,orange :height 1.2))
       ...
       (themian-unknown nil ,(when themian--show-unknowns
                                   `(:background ,unknown)))
       (themian-warning nil (:foreground ,yellow :background ,base-3 :weight bold))
       (themian-weak nil (:foreground ,base+2 :weight light))
       ...
       (header-line themian-header (:background ,base-3))
       ...
       (bookmark-menu-heading themian-header)
       ...
       ;; (dired-broken-symlink themian-unknown)
       ;; (dired-directory themian-unknown)
       ;; (dired-flagged themian-unknown)
       ;; (dired-header themian-unknown)
       ;; (dired-ignored themian-unknown)
       ;; (dired-mark themian-unknown)
       ;; (dired-marked themian-unknown)
       ;; (dired-perm-write themian-unknown)
       ;; (dired-set-id themian-unknown)
       ;; (dired-special themian-unknown)
       ;; (dired-symlink themian-unknown)
       ;; (dired-warning themian-unknown)
       ...
       ;; (org-agenda-calendar-sexp themian-unknown)
       ;; (org-agenda-clocking themian-unknown)
       ;; (org-agenda-column-dateline themian-unknown)
       ;; (org-agenda-current-time themian-unknown)
       ;; (org-agenda-date themian-unknown)
       ;; (org-agenda-date-today themian-unknown)
       ;; (org-agenda-date-weekend themian-unknown)
       ;; (org-agenda-diary themian-unknown)
       ;; (org-agenda-dimmed-todo-face themian-unknown)
       ...
       ;; (org-agenda-structure themian-unknown)
       ;; (org-archived themian-unknown)
       ;; (org-block themian-unknown)
       ;; (org-block-begin-line themian-unknown)
       ;; (org-block-end-line themian-unknown)
       ;; (org-checkbox themian-unknown)
       ;; (org-checkbox-statistics-done themian-unknown)
       ;; (org-checkbox-statistics-todo themian-unknown)
       ;; (org-clock-overlay themian-unknown)
       ;; (org-code themian-unknown)
       ;; (org-column themian-unknown)
       ;; (org-column-title themian-unknown)
       ;; (org-date themian-unknown)
       ;; (org-date-selected themian-unknown)
       ;; (org-default themian-unknown)
       ;; (org-dispatcher-highlight themian-unknown)
       ;; (org-document-info themian-unknown)
       ;; (org-document-info-keyword themian-unknown)
       ;; (org-document-title themian-unknown)
       ;; (org-done themian-unknown)
       ;; (org-drawer themian-unknown)
       ;; (org-ellipsis themian-unknown)
       ;; (org-footnote themian-unknown)
       ;; (org-formula themian-unknown)
       ;; (org-headline-done themian-unknown)
       ;; (org-headline-todo themian-unknown)
       ;; (org-hide themian-unknown)
       ;; (org-indent themian-unknown)
       ;; (org-latex-and-related themian-unknown)
       ;; (org-level-1 themian-unknown)
       ;; (org-level-2 themian-unknown)
       ;; (org-level-3 themian-unknown)
       ;; (org-level-4 themian-unknown)
       ;; (org-level-5 themian-unknown)
       ;; (org-level-6 themian-unknown)
       ;; (org-level-7 themian-unknown)
       ;; (org-level-8 themian-unknown)
       ;; (org-link themian-unknown)
       ;; (org-list-dt themian-unknown)
       ;; (org-macro themian-unknown)
       ;; (org-meta-line themian-unknown)
       ;; (org-mode-line-clock themian-unknown)
       ;; (org-mode-line-clock-overrun themian-unknown)
       ;; (org-priority themian-unknown)
       ;; (org-property-value themian-unknown)
       ;; (org-quote themian-unknown)
       ;; (org-scheduled themian-unknown)
       ;; (org-scheduled-previously themian-unknown)
       ;; (org-scheduled-today themian-unknown)
       ;; (org-sexp-date themian-unknown)
       ;; (org-special-keyword themian-unknown)
       ;; (org-table themian-unknown)
       ;; (org-table-header themian-unknown)
       ;; (org-tag themian-unknown)
       ;; (org-tag-group themian-unknown)
       ;; (org-target themian-unknown)
       ;; (org-time-grid themian-unknown)
       ;; (org-todo themian-unknown)
       ;; (org-upcoming-deadline themian-unknown)
       ;; (org-upcoming-distant-deadline themian-unknown)
       ;; (org-verbatim themian-unknown)
       ;; (org-verse themian-unknown)
       ;; (org-warning themian-unknown)
       ;; (outline-1 themian-unknown)
       ;; (outline-2 themian-unknown)
       ;; (outline-3 themian-unknown)
       ;; (outline-4 themian-unknown)
       ;; (outline-5 themian-unknown)
       ;; (outline-6 themian-unknown)
       ;; (outline-7 themian-unknown)
       ;; (outline-8 themian-unknown)
