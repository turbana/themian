...
(when (featurep 'themian-theme)
  ...
  (defun themian--show-colors ()
    (interactive)
    (themian--with-color-variables 'dark
      (insert (propertize "base-5    " 'face `(:foreground ,base-5))
              (propertize "base-5-bg " 'face `(:background ,base-5))
              "\n")
      (insert (propertize "base-4    " 'face `(:foreground ,base-4))
              (propertize "base-4-bg " 'face `(:background ,base-4))
              "\n")
      (insert (propertize "base-3    " 'face `(:foreground ,base-3))
              (propertize "base-3-bg " 'face `(:background ,base-3))
              "\n")
      (insert (propertize "base-2    " 'face `(:foreground ,base-2))
              (propertize "base-2-bg " 'face `(:background ,base-2))
              "\n")
      (insert (propertize "base-1    " 'face `(:foreground ,base-1))
              (propertize "base-1-bg " 'face `(:background ,base-1))
              "\n")
      (insert (propertize "base+1    " 'face `(:foreground ,base+1))
              (propertize "base+1-bg " 'face `(:background ,base+1))
              "\n")
      ...
      (insert (propertize "blue      " 'face `(:foreground ,blue))
              (propertize "blue-bg   " 'face `(:background ,blue))
              "\n")
      (insert (propertize "orange    " 'face `(:foreground ,orange))
              (propertize "orange-bg " 'face `(:background ,orange))
              "\n")
      (insert (propertize "red       " 'face `(:foreground ,red))
              (propertize "red-bg    " 'face `(:background ,red))
              "\n")
      (insert (propertize "magenta   " 'face `(:foreground ,magenta))
              (propertize "magenta-bg" 'face `(:background ,magenta))
              "\n")
      (insert (propertize "green     " 'face `(:foreground ,green))
              (propertize "green-bg  " 'face `(:background ,green))
              "\n")
      (insert (propertize "violet    " 'face `(:foreground ,violet))
              (propertize "violet-bg " 'face `(:background ,violet))
              "\n")
      (insert (propertize "cyan      " 'face `(:foreground ,cyan))
              (propertize "cyan-bg   " 'face `(:background ,cyan))
              "\n")
      (insert (propertize "yellow    " 'face `(:foreground ,yellow))
              (propertize "yellow-bg " 'face `(:background ,yellow))
              "\n")
      ))
  (define-key global-map (kbd "M-<f2>") 'themian--show-colors)
  )
